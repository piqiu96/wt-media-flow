"""
PublishCommand - 视频发布命令
从 video_tasks 表查询 composited 任务，通过比特浏览器 + Playwright 自动发布
"""
    ...
    def execute(self, args) -> dict:
        ...
        try:
            ...
            if not bit_profile_id and account.browser_id:
                from db.repositories import BrowserRepository
            ...
            for i, task in enumerate(tasks, 1):
                ...
                try:
                    ...
                    with sync_playwright() as p:
                        ...
                        upload_result = platform.upload_video(
